...
for(var god in gods){
    if(gods[god].roles.includes('Mid')){
        console.log(gods[god])
    }
}
console.log('\n')
console.log('EXERCICO C')


//letra c do exercicio------------------------------------------------------
function comparadorPorPantheon(a,b){
    const pantheonA = a.pantheon
    const pantheonB = b.pantheon
    if (pantheonA < pantheonB){
        return -1;
    }
    if (pantheonA > pantheonB){
        return 1;
...
var ordenada = gods.sort(comparadorPorPantheon)
for(var deus in ordenada){
    console.log(ordenada[deus])
}
...
var lista = []
for(var s = 0; s < gods.length; s++){
    lista.push(gods[s].name + '(' + gods[s].class + ')')
    console.log(lista[s])
}
